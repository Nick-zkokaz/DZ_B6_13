...
from sqlalchemy.dialects.postgresql import JSON   # в файле по рабору ДЗ нет такой строки НУЖНО УСТАНОВИТЬ ПАКЕТ
from sqlalchemy.orm import sessionmaker
from sqlalchemy.ext.declarative import declarative_base

DB_PATH = "sqlite:///albums.sqlite3"             # прикрепил исходную базу из разбора ДЗ
...
def find_alb(new_album):                         # в файле по рабору ДЗ нет такой функции
    """
...
def write_new_album(data_new):                                  # в файле по рабору ДЗ нет такой функции
